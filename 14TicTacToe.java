...
class TicTac
{
    public static void main(String args[])
    {
       ...
       // printtable();
        ...
        while(count<9)
        {
       	System.out.println("Enter the row and col you want to enter");											//pos='x';
		row=sc.nextInt();
        col=sc.nextInt();
...
public boolean checkForWin(char a[][]) {
    ...
    // {
    // 	boolean b1=false;
    // 	b1=(checkrow(a)||checkcol(a)||checkdia(a));
    // 	return b1;
    // }

    // static boolean checkrow(char a[][])
    // {
    // 	for(int i=0;i<3;i++)
    // 	{
    ...
    // static boolean checkcol(char a[][])
    // {
    // 	for(int i=0;i<3;i++)
    // 	{
    ...
    // static boolean checkdia(char a[][])
    // {
